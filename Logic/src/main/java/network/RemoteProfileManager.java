...
public class RemoteProfileManager implements RemoteProfile {
    ...
    @Override
    public List<Profile> getProfilesBySpecialty(Specialties specialty){
        try {
            return server.getProfilesBySpecialty(specialty);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    ...
    @Override
    public void addEntryToCalendar(String username, LocalDate date) {
        try {
            server.addEntryToCalendar(username, date);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    }
    ...
    @Override
    public List<LocalDate> getDatesOfEmployee(String username)  {
        try {
            return server.getDatesOfEmployee(username);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
